      ...
      <div className="max-w-5xl w-full">
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-balance">Victor Felippe Magdesian</h1>
            <p className="text-2xl md:text-3xl text-muted-foreground">Fullstack Developer</p>
